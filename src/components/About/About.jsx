...
const About = () => {
  return (
    <section
      id="about"
      className="py-8 px-6 sm:px-12 md:px-16 lg:px-20 xl:px-32 font-sans mt-16 md:mt-24 lg:mt-32"
    >
      <div className="flex flex-col-reverse md:flex-row justify-between items-center gap-10 md:gap-16">
        ...
        <div className="md:w-1/2 text-center md:text-left">
          ...
          {/* Name */}
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-4 leading-snug">
            Swaraj Phalke
          </h2>
          ...
          {/* Resume Button */}
          <a
            href="https://drive.google.com/file/d/16WLRHxKB-ttiiSQkMGE2nsbTYgS395Sr/view?usp=sharing"
            target="_blank"
