  ...
  return (
    <footer className="text-white py-8 px-[12vw] md:px-[7vw] lg:px-[20vw]">
      <div className="container mx-auto text-center">
        <h2 className="text-xl font-semibold text-purple-500 select-none">Swaraj Phalke</h2>

        <nav className="flex flex-wrap justify-center space-x-4 sm:space-x-6 mt-4 select-none">
          {[
            { name: "About", id: "about" },
